...
$query=mysqli_query($conn,"select * from Item where id =45 ");
...
<h1 ><strong>  Half Million Cafe <strong> </h1>

<div style = "position:absolute; left:3%; top:27%;"> <img src="Images/one.png" width = "250" height ="150" alt="jolt COFFEE" ></div>
 <div class="vl2"></div>


<div style = "position:absolute; left:24%; top:32%; "> <img src="Images/check.png" alt="CHECK " width="30" height="30"></div>
<div style = "position:absolute; left:27%; top:33%; font-weight :lighter; "> <em> Cozy / Relaxing  </em> </div>
<div style = "position:absolute; left:24%; top:37%; "> <img src="Images/check.png" alt="CHECK " width="30" height="30"></div>
<div style = "position:absolute; left:27%; top:37%;font-weight : lighter;  "> <em>Meeting Rooms </em> </div>
<div style = "position:absolute; left:24%; top:42%; "> <img src="Images/check.png" alt="CHECK " width="30" height="30"></div>
<div style = "position:absolute; left:27%; top:42%;font-weight : lighter;  "> <em>Studying </em></div>
