...
$query=mysqli_query($conn,"select * from Item where id =43 ");
...
<h1 ><strong>  Starbucks Cafe <strong> </h1>

<div style = "position:absolute; left:3%; top:27%;"> <img src="Images/starbox.png" width = "250" height ="170" alt="jolt COFFEE" ></div>
 <div class="vl2"></div>


<div style = "position:absolute; left:24%; top:32%; "> <img src="Images/check.png" alt="CHECK " width="30" height="30"></div>
<div style = "position:absolute; left:27%; top:33%; font-weight :lighter; "> <em> Music </em> </div>
<div style = "position:absolute; left:24%; top:37%; "> <img src="Images/check.png" alt="CHECK " width="30" height="30"></div>
<div style = "position:absolute; left:27%; top:37%;font-weight : lighter;  "> <em> Parking </em> </div>
<div style = "position:absolute; left:24%; top:42%; "> <img src="Images/check.png" alt="CHECK " width="30" height="30"></div>
<div style = "position:absolute; left:27%; top:42%;font-weight : lighter;  "> <em> Amazing atmosphere :)  </em></div>
...
$query=mysqli_query($conn,"select * from Review where item_id =43 ");
