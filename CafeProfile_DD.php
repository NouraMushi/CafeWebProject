...
<head>
<meta charset = "utf-8">
<title> Dunkin Cafe profile  </title>
...
$query=mysqli_query($conn,"select * from Item where id =48 ");
...
<h1 ><strong>  Dunkin Donuts Cafe <strong> </h1>

<div style = "position:absolute; left:3%; top:27%;"> <img src="Images/DD.jpeg" width = "250" height ="150" alt="dunkincafe COFFEE" ></div>
 <div class="vl2"></div>


<div style = "position:absolute; left:24%; top:32%; "> <img src="Images/check.png" alt="CHECK " width="30" height="30"></div>
<div style = "position:absolute; left:27%; top:33%; font-weight :lighter; "> <em> Cozy</em> </div>
<div style = "position:absolute; left:24%; top:37%; "> <img src="Images/check.png" alt="CHECK " width="30" height="30"></div>
<div style = "position:absolute; left:27%; top:37%;font-weight : lighter;  "> <em> Music</em> </div>
<div style = "position:absolute; left:24%; top:42%; "> <img src="Images/check.png" alt="CHECK " width="30" height="30"></div>
<div style = "position:absolute; left:27%; top:42%;font-weight : lighter;  "> <em> Has Wi-Fi </em></div>





<form action="" class="search-form2" align="center">
        <input type="search"  style="text-align:center" placeholder="Search" id="search-box" >
...
$query=mysqli_query($conn,"select * from Review where item_id =48 ");
